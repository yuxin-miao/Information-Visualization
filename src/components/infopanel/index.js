...
export const InfoPanel = (props) => {
    ...
    return (
        <div className="info-grid w-full h-full font-ssp text-white p-3" style={{ backgroundColor: 'rgba(0,0,0,0.65)' }}>
            <div className='col-start-2 col-span-5 row-span-2 flex h-min justify-center self-center text-center font-bold' style={{ fontSize: '100%' }}>
            ...
            <div className='row-start-3 self-center justify-self-center flex gap-2' style={{ fontSize: '100%' }}>
                <img src={TypeIcon} className='h-min w-auto' />
                <p>{props.animeType}</p>
            </div>
            <div className='row-start-3 col-start-3 col-span-3 self-center justify-self-center flex gap-2' style={{ fontSize: '100%' }}>
            ...
            <div className='row-start-3 col-start-6 col-span-full self-center justify-self-center flex gap-2' style={{ fontSize: '80%' }}>
                <img src={StudioIcon} className='h-min w-auto' />
                <p>{props.animeStudio ? props.animeStudio : ''}</p>
            </div>
            <div className='row-start-4 col-span-full px-5 my-2 text-justify' style={{ overflowY: "scroll" }}>
